...
int main(int argc, char** argv) {
  ...
  try {
    ...
    if (o_benchmark)
    {
      std::cout << std::endl << "Performing " << o_iterations << " iteration tests..." << std::endl << std::endl
        << "Please wait, this may take a while depending on your system..." << std::endl << std::endl;
